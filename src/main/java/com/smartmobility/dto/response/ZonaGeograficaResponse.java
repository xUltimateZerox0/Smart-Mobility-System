...
public class ZonaGeograficaResponse {
    ...
    public ZonaGeograficaResponse(Long id, String nome, String tipoRestrizione, String noteRestrizione, String zona) {
        this.id = id;
        this.nome = nome;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(nome, that.nome) && Objects.equals(tipoRestrizione, that.tipoRestrizione) && Objects.equals(noteRestrizione, that.noteRestrizione) && Objects.equals(zona, that.zona);
    }

    @Override
    public int hashCode() { return Objects.hash(id, nome, tipoRestrizione, noteRestrizione, zona); }

    @Override
    public String toString() { return "ZonaGeograficaResponse{id=" + id + ", nome='" + nome + "', tipoRestrizione='" + tipoRestrizione + "', noteRestrizione='" + noteRestrizione + "', zona='" + zona + "'}"; }
}
